                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="row pb-2">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text mr-2"><i class="fas fa-smile"></i></span>
                                <a href="{{ route('user.miembro.show', $miembro->user->id) }}" class="bg-green-600 rounded w-1/4 text-white text-center">
                                    Ir
                                </a>
                            </div>
                        </div>
