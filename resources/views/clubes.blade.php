          ...
          <div class="card card-info card-tabs">
            <div class="card-header p-0 pt-1">
              <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="alta-club-tab" data-toggle="pill" href="#alta-club" role="tab" aria-controls="alta-club" aria-selected="true">Alta</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
              <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade show active" id="alta-club" role="tabpanel" aria-labelledby="alta-club-tab">
                    <!-- Main content -->
                    <section class="content">
                        <h1>hello alta</h1>
                    </section>
