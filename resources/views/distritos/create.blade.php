                    ...
                    <form action="/distrito" method="POST">
                        ...
                        <div class="md:w-1/2 mb-6 md:mb-0">
                            ...
                            <div class="input-group-prepend">
                                <select class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" name="estado" id="estado" :value="old('estado')" required> 
                        ...
                        <div class="md:w-1/2 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border rounded py-3 px-4 mb-3" id="ciudad" type="text" name="ciudad" :value="old('ciudad')" required>
                            {{-- <p class="text-red text-xs italic">Please fill out this field.</p> --}}
                        </div>
                        </div>
